---
title: "FAQ"
description: "Frequently asked questions about RECAP"
---
...
### How do I use the API key in my requests to my RECAP instance's server endpoints?
If you are trying to use any RECAP endpoint that requires authorization, such as the [Answer with Quote](/apis/answer_with_quote) endpoint, 
