...
2. Navigate to the base folder of your RECAP repository.
...
2. Identify the `<CONTAINER_ID>` of your API server container. It should contain the string `RECAP-api`. You can list all running containers with:
   ```
   docker ps -a
   ```
