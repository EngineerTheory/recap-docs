...
## How it works
Slab is a wiki tool where the pages are called Posts. RECAP indexes the post **titles** and **contents**.
...
### Indexing
    ...
    - In the video example above, it would be `RECAPai.slab.com`
