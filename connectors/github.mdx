...
### Authorization
    ...
    5. Click on **Generate new token**
        ...
        - Set any expiration time. A new token will have to be provided to Recap to continue updating the Recap
        index once this one expires.

### Indexing
    1. Navigate to the Admin Dashboard and select the **GitHub** Connector
    2. For [https://github.com/Recap-ai/Recap](https://github.com/Recap-ai/Recap), it would look like:
