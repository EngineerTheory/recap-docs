...
<img src="/images/connectors/discourse/discourse_1.gif" width="400" height="auto" alt="NavigateToAPIKeys" title="NavigateToAPIKeys" />
    ...
    4. Click **New API Key**, name it "Recap". Select "All Users" for **User Level** and "Read-only" for **Scope**.

![FillOutAPIKey](/images/connectors/discourse/discourse_2.gif)

    5. Click **Save**. Copy the key and put it into Recap.
...
![FillOutRecap](/images/connectors/discourse/discourse_4.gif)
