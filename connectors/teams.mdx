...
### Authorization
    ...
    4. Name it something like “Recap Teams Connector”, leave everything else as default, and click **Register**.
    5. Under “Essentials” in the overview tab, you will find the client ID and Directory ID, copy paste those into the Recap connector.
    ...
    8. Copy the secret value in the **Value** column and paste it into the Recap connector.
