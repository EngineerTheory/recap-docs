...
4. Set a name for the new user (e.g., "RECAPS3Connector") and click "Next".
...
![RECAP S3 page 1](/images/connectors/blob/s3/RECAP1.png)
...
![RECAP S3 page 2](/images/connectors/blob/s3/RECAP2.png)
...
![RECAP S3 page 3](/images/connectors/blob/s3/RECAP3.png)
