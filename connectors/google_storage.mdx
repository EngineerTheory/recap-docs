...
4. Set a name for the new service account (e.g., "Recap-gcs-connector") and click "Create".
...
![Recap page1](/images/connectors/blob/google/Recap1.png)
...
![Recap page1](/images/connectors/blob/google/Recap2.png)
