...
## Setting up
### Authorization
    1. Recap interfaces with Zulip as a Zulip Bot which is authenticated using the `zuliprc` config format.
...
![ZulipRC](/images/connectors/zulip/ZulipRC.png)
    ...
    Keep this copied text to provide to Recap in the next step
...
![RecapZulipConfig](/images/connectors/zulip/RecapZulipConfig.png)
