...
5. Give your token a name (e.g., "RecapR2Connector") and select the appropriate permissions (Object Read only).
...
![Recap page 1](/images/connectors/blob/r2/id.png)
...
![Recap page 2](/images/connectors/blob/r2/Recap1.png)
...
![Recap page 2](/images/connectors/blob/r2/Recap2.png)
