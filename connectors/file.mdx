...
There is also an optional metadata line that supports links, document owners, and time updated as metadata for Recap's retrieval and AI Answer.

## Adding Metadata

The metadata line should be placed at the very top of the file and can take one of two formats:

- `#Recap_METADATA={"link": "<LINK>"}`
- `<!-- Recap_METADATA={"link": "<LINK>"} -->`

Where Recap_METADATA= is followed by a json.
...
```
#Recap_METADATA={"link": "https://github.com/Recap-ai/Recap/blob/main/CONTRIBUTING.md", "primary_owners": ["yuhong@Recap.ai", "chris@Recap.ai"], "secondary_owners": ["founders@Recap.ai"], "doc_updated_at": "2023-11-30T13:06:08.589616-08:00", "file_display_name": "Desired File Name!", "tag_of_your_choice": "tag_value"}
```

Full file example:

```
#Recap_METADATA={"link": "https://www.Recap.com/captcha", "file_display_name": "Captcha Setup"}
...
Alternatively, if you are uploading a `.zip` filled with files, you can define a `.Recap_metadata.json` file and include that in the root of the zip file. 
...
then your `.Recap_metadata.json` file might look like:
