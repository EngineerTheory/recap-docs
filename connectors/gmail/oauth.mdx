...
![GmailCredential](/images/connectors/google_drive/GoogleDriveCredential.png)
        ...
        - Add a **Authorized redirect URIs** for `http://localhost:3000/admin/connectors/gmail/auth/callback` (or `https://<INTERNAL_DEPLOYMENT_URL>/admin/connectors/gmail/auth/callback` if you have setup Recap for production use)
