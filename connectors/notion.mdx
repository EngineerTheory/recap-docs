...
In order to authorize Recap to connect to your Notion workspace, you'll need to create a new integration in 
...
#### Step 1: Create an integration
    ...
    3. Name the integration (something like "Recap" could work).
    4. Select "Read content" as the only capability required for Recap.
    5. Click Submit to create the integration.

On the next page, you’ll find your Notion integration token, also called an API key. You’ll need this
token to configure Recap to index Notion, so make a copy of it.
...
You must share specific pages with an integration in order for Recap to access those pages.
...
To share a page/database with your integration:
    ...
    5. If you've added a page, all child pages also become accesssible to Recap. 
    If you've added a database, all rows (and their children) become accessible to Recap.

![Notion add connection](/images/connectors/notion/NotionAddConnector.png)

Once you've granted access to a page/database, you can start configuring Recap to index those databases.
...
![Notion connector step 1 view](/images/connectors/notion/NotionAuth.png)
    ...
    3. Click the `Connect` button! Your content will then be pulled into Recap every **10** minutes.
