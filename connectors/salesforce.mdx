...
![SalesforceConnectorAuth](/images/connectors/salesforce/salesforce_3.png)
    ...
    5. Once the token has been regenerated, you can use it (as well as your username and password) to authorize your Recap connector
...
### Indexing
    ...
    3. Enter the [Salesforce Object(s)](https://developer.salesforce.com/docs/atlas.en-us.object_reference.meta/object_reference/sforce_api_objects_list.htm) you wish to index and organize your Recap documents by.
...
![SalesforceConnectorAuth](/images/connectors/salesforce/salesforce_4.png)
    - Recap will generate a document for every single **Account** in your Salesforce
