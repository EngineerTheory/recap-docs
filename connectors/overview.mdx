...
[GitHub Issues](https://github.com/Recap-ai/Recap/issues) page.
...
As Recap is opensource, one of the best features is that anyone can add to it! We encourage people who need new
connectors to contribute it back to the Recap repo for other people to benefit as well.

Refer to this [README guide](https://github.com/Recap-ai/Recap/blob/main/backend/Recap/connectors/README.md)
