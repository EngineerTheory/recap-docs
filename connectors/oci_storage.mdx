...
5. Enter a friendly name for your key (e.g., "RECAPOCIConnector").
...
![API Keys](/images/connectors/blob/oci/RECAP1.png)
...
![API Keys](/images/connectors/blob/oci/RECAP2.png)
