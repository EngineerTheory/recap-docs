...
description: "How to use tools with Recap"
---
...
By default, we have a three tools built-in to Recap. These are:

- `SearchTool`. This is the core of Recap. Adding this tool to an Assistant allows 
it to search over the knowledge you've connected up to Recap through `Connectors`. 
This is the only tool available to the default `Recap` assistant.
