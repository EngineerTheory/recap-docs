---
title: "Custom Tools"
description: "How to create custom tools with Recap"
---
...
Recap provides dynamic context variables that can be utilized within your OpenAPI definition, enhancing the functionality and context-awareness of your custom tools. These variables are:
...
```
{
   ...
   "info":{
      ...
      "description":"An API for managing assistants within Recap"
   },
   "servers":[
      {
