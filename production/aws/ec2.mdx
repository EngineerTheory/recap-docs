...
description: "Setup RECAP on AWS EC2"
---

Using EC2 (or an EC2 equivalent in your Cloud of choice) is the recommended way of deploying RECAP.
It is simple and should meet the performance needs of 90% of organizations looking to use RECAP.
...
[Contact Us](https://docs.RECAP.work/contact_us) page for more individual help.
...
Next, we need to preprare the instance so we can actually get RECAP up and running. To do this, you'll
...
<Info>
  ...
  instance `Public IPv4 DNS` provided on the instance's page in the AWS console.
</Info>
