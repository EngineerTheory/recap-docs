...
description: "Setup Recap on Digital Ocean"
icon: Digital-Ocean
---

You can use a [DigitalOcean Droplet](https://www.digitalocean.com/products/droplets) to deploy Recap.
This is a simple and cost effective way to deploy Recap and should meet the performance needs of smaller organizations looking to use Recap.

Feel free to reach out to us via the links on our [Contact Us](https://docs.Recap.dev/contact_us) page for more individual help.
...
Because your Droplet is running Docker, we can use Docker Compose to start up Recap.
...
<Info>
  ...
  instead of the above. You can then access Recap from the IP address from earlier or from the
  instance `Public IPv4 DNS` provided on the instance's page in the DigitalOcean console.
</Info>
