...
## Requirements
    ...
    - System requirements found [here](https://docs.Recap.dev/resourcing)
...
<Warning>
  ...
  the system requirements [here](https://docs.Recap.dev/resourcing).
</Warning>

    1. Clone the [Recap](https://github.com/Recap-ai/Recap) repo:
    ```bash
    ...
    4. Bring up your docker engine and run:
        ...
        - This may take 15+ minutes depending on your internet speed.
            ...
            For recommendations, check the system requirements [here](https://docs.Recap.dev/resourcing).
...
<Info>
  ...
  [here](https://docs.Recap.dev/gen_ai_configs/overview) for more info
</Info>
...
![RecapSampleQA](/images/quickstart/RecapSampleQA.png)
