...
[**Configuration**](https://docs.Recap.dev/multilingual_setup#configuration) section below.
...
[here](https://github.com/Recap-ai/Recap/tree/main/backend/Recap/prompts).
...
[See here for reference](https://github.com/Recap-ai/Recap/blob/main/deployment/docker_compose/env.multilingual.template).

## Example
If you've configured everything correctly, you should now be able to get good answers across the different
languages that you've set the system up for.s