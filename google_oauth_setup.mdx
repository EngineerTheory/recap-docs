...
- Provide any email you own (or founders@Recap.ai if you want us to handle questions from your Recap users)
- Upload the Recap logo (or leave blank)
- The **Developer contact information** can be any email you own (or again, founders@Recap.ai)
...
Simply set the above environment variables when running the different Recap processes.
...
Simply set the 4 environment variables in a file called **.env** under **Recap/deployment/docker_compose**.
