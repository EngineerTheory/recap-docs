---
title: Resourcing
description: "Recommended CPU / RAM / Disk to run RECAP"
icon: "desktop"
---
...
[EC2 deployment guide](https://docs.RECAP.work/production/aws/ec2).
...
For reference, we have chosen to give each RECAP Cloud customer a `m7g.xlarge` instance by default,
