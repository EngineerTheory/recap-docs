...
description: 'Configure Recap to use HuggingFace APIs'
---

Refer to [Model Configs](https://docs.Recap.dev/gen_ai_configs/overview#model-configs) for how to set the
...
## Set Recap to use `Llama-2-70B` via next-token generation prompting
...
The *Pro Plan* still supports smaller models but these produce worse results for Recap.
