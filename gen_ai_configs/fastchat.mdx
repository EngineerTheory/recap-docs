---
title: FastChat
description: 'Configure Recap to use FastChat model servers'
---
...
## What is FastChat
FastChat is a way to easily host LLMs on cli, using their web client, or as an API server. For the Recap use
