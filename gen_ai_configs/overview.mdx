...
description: 'Overview of the Generative AI functionality in Recap'
---

## LLM Options
Recap supports a large range of LLM hosting services and local/custom such as:
...
- Host the model yourself for complete control and flexibility
    - The Gen AI is the only feature in Recap that reaches out to third party controlled service
...
## Recap LLM Configs
To setup various LLMs, head to the `LLM` page on the Admin Panel. A fun thing about Recap is that 
...
As always, don't hesitate to reach out to the [Recap team](https://docs.Recap.dev/contact_us) if you have any
questions or issues!
