...
description: 'Configure RECAP to use a Custom Model Server via requests'
---

RECAP can also make requests to an arbitrary model server via REST requests. Optionally an access token can be passed
in. To customize the request format and handling of the response, it may be necessary to update/rebuild the RECAP
containers.
...
Simply update the code [here](https://github.com/RECAP-ai/RECAP/blob/main/backend/RECAP/llm/custom_llm.py#L14)
and [rebuild](https://docs.RECAP.work/quickstart#setup).
