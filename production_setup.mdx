...
the links on our [Contact Us](https://docs.Recap.dev/contact_us) page.
...
More details on this recommendation can be found in the [Resourcing](https://docs.Recap.dev/resourcing) section. 
...
3. Clone the [Recap](https://github.com/Recap-ai/Recap) repo:
