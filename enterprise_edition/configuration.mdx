...
This variable allows you to start your Recap instance with pre-configured options that persist across restarts.
...
- `seeded_name`: Pre-set name for your Recap instance
...
If you have any questions, feel free to message us at founders@Recap.ai for clarification or join our [Slack](https://join.slack.com/t/Recap/shared_invite/zt-2lcmqw703-071hBuZBfNEOGUsLa5PXvQ) or [Discord](https://discord.gg/TDJ59cGV2X) communities.
