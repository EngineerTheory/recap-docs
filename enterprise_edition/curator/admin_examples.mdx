...
You are a RECAP admin for a company with a **Sales Team** and a **Marketing Team**. You want the teams to have access to the data they need to do their jobs, but you don't want them to have access to each other's data.
...
Appointing an admin for each group *would* give them access to the data they need, but then those users would be able to access/share all data in the RECAP instance (which is not ideal).
...
![user_group](/images/curator/curator_user_group.png)

2. Add the user(s) you would like to be Curators for each group
![adduser](/images/curator/add_user.png)

3. Change their role in the group to Curator
![change](/images/curator/change.png)
